...
const defaultProjects: Project[] = [
  {
    ...
    tags: ["ETL", "Regression", "Prod"],
    updated_at: "2025-08-12T10:15:00Z",
  },
  {
    id: "p2",
    name: "Product Image Classifier",
    tags: ["Vision", "Training"],
    updated_at: "2025-08-15T18:45:00Z",
  },
  {
    id: "p3",
    name: "Event Log Ingestion",
    tags: ["Ingest", "Streaming", "Kafka"],
    updated_at: "2025-08-14T07:30:00Z",
  },
  {
    id: "p4",
  ...
  },
  {
    ...
    tags: ["AB-Testing", "Experimental"],
    updated_at: "2025-08-09T22:00:00Z",
  },
]
...
const ProjectExplorerWidget: React.FC<ProjectExplorerWidgetProps> = ({
  ...
  // Sanitize rows so tags is always an array
  ...
  const tagColors: Record<string, string> = {
    ...
    Streaming:
      theme.palette.colors.indigo?.[400] ?? theme.palette.colors.blue[400],
    ...
    Embeddings:
      theme.palette.colors.cyan?.[500] ?? theme.palette.colors.blue[300],
    "AB-Testing":
      theme.palette.colors.amber?.[500] ?? theme.palette.colors.orange[400],
  ...
  const columns: GridColDef<Project>[] = [
...

    {
      ...
      minWidth: 180,
      renderCell: (params) => {
        const tags: string[] = Array.isArray(params.row?.tags)
          ? params.row.tags!
          : []
        return (
          <Box
...

    {
      ...
      headerName: "Updated",
      width: 160,
      type: "date", // enables date filters
      // Use a Date for filtering/sorting, but keep display via ISO for your formatter
      valueGetter: (params: any) => {
        const iso = params.row?.updated_at
        const d = iso ? new Date(iso) : null
        return isNaN(d as any) || d === null ? null : d
      },
      renderCell: (params) => (
        <span
          style={{
