// datasetEditLoader.ts
import type { LoaderFunctionArgs } from "react-router-dom";
import { apolloClient } from "../apollo/apolloClient";
import { DATASET_EDIT_QUERY } from "../graphql/query/datasetQuery";
import { DATASTORE_FILES_QUERY } from "../graphql/query/datastoreQuery";

export async function datasetEditLoader({ params }: LoaderFunctionArgs) {
  ...
  // 2) Fetch datastore files (limit/offset paging)
  const limit = 50;
  const offset = 0;
