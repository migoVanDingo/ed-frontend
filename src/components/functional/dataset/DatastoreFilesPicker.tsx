...
type DatastoreFilesPickerProps = {
...
const DatastoreFilesPicker = ({
  initialFiles,
  onSelectionChange,
}: DatastoreFilesPickerProps) => {
  ...
  return (
    ...
    >
      ...
      >
        <HeadingBlock
          heading="Datastore Files"
          headingSize="h5"
          headingWeight={theme.custom.font.weight.regular}
          subheading="Select files to add to this dataset."
          padding={0}
        />
        <TextField
...
export default DatastoreFilesPicker
